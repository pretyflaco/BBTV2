...
Android companion app for printing receipts from [Blink Bitcoin Terminal](https://github.com/your-repo/blink-bitcoin-terminal).
...
- Developed for [Blink Bitcoin Terminal](https://github.com/your-repo/blink-bitcoin-terminal)
