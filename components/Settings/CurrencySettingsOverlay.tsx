...
interface CurrencySettingsOverlayProps {
    ...
    <div className={`fixed inset-0 ${getSubmenuBgClasses()} z-50 overflow-y-auto`}>
      ...
      >
        ...
        <div className={`${getSubmenuHeaderClasses()} sticky top-0 z-10`}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              ...
              <h1 className={`text-xl font-bold ${getPrimaryTextClasses()}`}>Currency</h1>
            ...
            <div className="relative">
              <input
                ...
                className={`w-full px-4 py-2.5 pl-10 rounded-lg text-sm ${
                  ...
                  isBlinkClassic
                    ? "focus:ring-blink-classic-amber"
                    : "focus:ring-blue-500"
                }`}
              />
              <svg
                className={`absolute left-3 top-1/2 transform -translate-y-1/2 w-4 h-4 ${getSecondaryTextClasses()}`}
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
        ...
        <div className="max-w-md mx-auto px-4 py-4">
          {currenciesLoading ? (
            <div className={`text-center py-4 ${getSecondaryTextClasses()}`}>
              Loading...
            </div>
          ) : (
            (() => {
              ...
              const matchesCurrency = (currency: CurrencyItem): boolean => {
                ...
                const country = ((currency.country as string) || "").toLowerCase()
                return (
