...
export default function KeyManagementSection() {
  ...
  const [copied, setCopied] = useState(null); // 'npub' | 'nsec' | null
  ...
  const handleExportNsec = async () => {
    ...
    try {
      ...
      const privateKey = await CryptoUtils.decryptWithPassword(encryptedNsec, password);
          ...
          {!isGeneratedAccount && (
            <div className={`p-3 rounded-lg ${darkMode ? 'bg-gray-800' : 'bg-blue-50'}`}>
              <p className={`text-xs ${darkMode ? 'text-gray-400' : 'text-blue-700'}`}>
                🔐 Your private key is securely managed by your external signer app. 
                This app only has access to your public key.
              </p>
            </div>
          )}
          ...
          <div className={`w-full max-w-md rounded-xl p-6 ${
            ...
            {!exportedNsec ? (
              ...
              <>
                ...
                <div className={`p-3 rounded-lg font-mono text-xs break-all mb-4 ${
          ...
          <div className={`w-full max-w-md rounded-xl p-6 ${
            ...
            <div className={`p-3 rounded-lg mb-4 ${
              ...
              <p className={`text-sm ${darkMode ? 'text-red-300' : 'text-red-700'}`}>
                <strong>Warning:</strong> This will delete your encrypted private key from this device. 
                If you haven't exported your nsec, you will lose access to this Nostr identity forever.
              </p>
            </div>
