...
const MigrationService = require('../../lib/migration/MigrationService');
...
export default function MigrationSection() {
  ...
  const handleMigrate = async () => {
    ...
    try {
      ...
      MigrationService.startMigration(user.username);

      // Step 2: Get public key from extension
      if (!window.nostr) {
        throw new Error('No Nostr extension found. Please install keys.band or another NIP-07 extension.');
      }
      ...
      const result = await MigrationService.completeMigration(publicKey);
      ...
      const ProfileStorage = (await import('../../lib/storage/ProfileStorage.js')).default;
  ...
  const handleMigrateWithSigner = () => {
    ...
    setError('External signer migration coming soon. Please use a browser extension like keys.band for now.');
  };
    ...
    return (
      <div className="p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h4 className="font-medium text-green-800 dark:text-green-200">Migration Complete!</h4>
    ...
    <div className="space-y-4">
      <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
        ...
        <p className="text-sm text-blue-600 dark:text-blue-400 mb-4">
          Connect your Nostr identity to enable passwordless sign-in with your browser extension or mobile signer.
          Your Blink account and settings will be preserved.
        </p>
