...
const getStages = (waitingForApproval) => [
      ...
      <div className="bg-white dark:bg-gray-900 rounded-2xl max-w-sm w-full shadow-xl overflow-hidden max-h-[90vh] flex flex-col">
        ...
        <div className="px-6 py-5 overflow-y-auto flex-1 min-h-0">
          ...
          {isInConnectionFlow && (stage !== 'waiting' || isIOS || isAndroid) && (
            <div className="py-2">
              <ProgressStepper stages={getStages(awaitingApproval)} currentStage={stage} errorStage={null} waitingForApproval={awaitingApproval} />
