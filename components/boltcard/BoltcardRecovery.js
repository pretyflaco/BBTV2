...
export default function BoltcardRecovery({ onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/50 flex items-end sm:items-center justify-center">
      <div className={`w-full sm:max-w-md max-h-[90vh] sm:max-h-[85vh] sm:mx-4 sm:rounded-xl shadow-2xl overflow-hidden flex flex-col ${
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <p className={`mt-1 text-xs ${darkMode ? 'text-gray-500' : 'text-gray-400'}`}>
                  14 hex characters (7 bytes). Find this on the card or use an NFC reader app.
                </p>
              </div>
              ...
              <div>
                ...
                <p className={`mt-1 text-xs ${darkMode ? 'text-gray-500' : 'text-gray-400'}`}>
                  If reset fails, try other versions. Cards increment version when re-programmed.
                </p>
              </div>
