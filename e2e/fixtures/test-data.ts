...
// Staging environment test credentials — loaded from environment variables.
// Set these in .env.test or CI secrets. NEVER hardcode credentials here.
export const TEST_CREDENTIALS = {
  // API Keys for staging environment
  apiKeys: {
    readReceiveWrite: process.env.E2E_BLINK_API_KEY || "",
    readReceive: process.env.E2E_BLINK_READ_API_KEY || "",
  },

  // Test Nostr account
  nostr: {
    nsec: process.env.E2E_NOSTR_NSEC || "",
    npub: process.env.E2E_NOSTR_NPUB || "",
  },
}
