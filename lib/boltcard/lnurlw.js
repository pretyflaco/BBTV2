...
async function handleWithdrawCallback(cardId, invoice, payInvoice) {
  ...
  console.log(`[LNURLW] handleWithdrawCallback: cardId=${cardId}, walletCurrency=${card.walletCurrency}, invoiceAmount=${JSON.stringify(invoiceAmount)}, amount=${amount}, cardBalance=${card.balance}`);
