 ...
 * @param {'production' | 'staging'} env - Environment name
 * @returns {string} GraphQL API URL for the specified environment
 */
export function getApiUrlForEnvironment(env) {
 ...
 * @param {'production' | 'staging'} env - Environment name
 * @returns {string} WebSocket URL for the specified environment
 */
export function getWsUrlForEnvironment(env) {
 ...
 * @param {'production' | 'staging'} env - Environment name
 * @returns {string} Pay URL for the specified environment
 */
export function getPayUrlForEnvironment(env) {
