...
export function useCurrencies() {
   ...
   * - BTC (sats) first
   * - All fiat currencies sorted alphabetically
   * - Street rate currencies injected after their base (e.g., MZN_STREET after MZN)
   * - Citrusrate alternative currencies injected after their base (e.g., NGN_CITRUS after NGN)
  ...
  const getAllCurrencies = () => {
    ...
    for (const currency of allFiatCurrencies) {
      ...
      // Check if there's a street rate version of this currency (e.g., MZN_STREET)
