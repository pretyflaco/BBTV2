...
import { formatDisplayAmount, getCurrencyById, SAT_CURRENCY, BTC_BIP177_CURRENCY } from '../currency-utils';
...
export function useCurrencies() {
  ...
  // Get all currencies including BTC options (sats first, BIP-177 second, then fiat)
  const getAllCurrencies = () => {
    return [SAT_CURRENCY, BTC_BIP177_CURRENCY, ...currencies];
  };
