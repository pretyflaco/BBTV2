...
export type NumberFormat = 'auto' | 'en-US' | 'de-DE' | 'fr-FR' | 'es-ES' | 'pt-BR' | 'ja-JP' | 'zh-CN';

/** Bitcoin format options */
export type BitcoinFormat = 'sats' | 'btc' | 'bip177';

/** Numpad layout options */
export type NumpadLayout = 'calculator' | 'phone';
