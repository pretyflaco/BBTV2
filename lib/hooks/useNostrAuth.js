 ...
 * Build version: v17-fix-race-condition
 * 
 * Provides:
...
export function NostrAuthProvider({ children }) {
  ...
  useEffect(() => {
    const checkAuth = async () => {
      ...
      console.log('[useNostrAuth] BUILD VERSION: v18-show-build-version');
      console.log('[useNostrAuth] checkAuth() ENTRY - authCheckInitiated:', authCheckInitiated.current, 'challengeFlowHandling:', challengeFlowHandling.current);
