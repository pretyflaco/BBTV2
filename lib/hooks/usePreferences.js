...
export function usePreferences(userPubkey) {
  ...
  const loadFromLocalStorage = useCallback(() => {
    ...
    try {
      return {
        ...
        numpadLayout: localStorage.getItem(PREFERENCES_KEYS.numpadLayout) || DEFAULT_PREFERENCES.numpadLayout
      };
    } catch (err) {
  ...
  return {
    ...
    setNumpadLayout: (value) => updatePreference('numpadLayout', value),
