 ...
 */
export const FIXED_VIEWS: DashboardView[] = ['pos', 'cart', 'voucher', 'multivoucher', 'vouchermanager'];

/**
 * Voucher-related views
 */
export const VOUCHER_VIEWS: DashboardView[] = ['voucher', 'multivoucher', 'vouchermanager'];
 ...
 * ```
 */
export function useViewNavigation(initialView: DashboardView = 'pos'): UseViewNavigationReturn {
  // ===========================================================================
  // Core State
  // ===========================================================================
   ...
   */
  const navigateToView = useCallback((view: DashboardView, transitionDelay = DEFAULT_TRANSITION_DELAY) => {
