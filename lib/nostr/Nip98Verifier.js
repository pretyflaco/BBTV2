...
function loadModules() {
  ...
  try {
    // Use require() which works in Next.js API routes
    // @noble/curves provides CommonJS exports
 ...
 * @returns {string} - Event ID as hex string
 */
