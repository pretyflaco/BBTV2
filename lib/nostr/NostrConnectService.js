    ...
    try {
      ...
      for (let attempt = 1; attempt <= maxRetries; attempt++) {
        try {
          ...
          // v37: Log the exact bunker pointer being used
          console.log('[NostrConnect] v37: Creating BunkerSigner with:');
          console.log('[NostrConnect] v37:   bunkerPointer.pubkey:', bunkerPointer.pubkey);
          console.log('[NostrConnect] v37:   bunkerPointer.secret:', bunkerPointer.secret);
          console.log('[NostrConnect] v37:   bunkerPointer.relays:', JSON.stringify(bunkerPointer.relays));
          console.log('[NostrConnect] v37:   clientSecretKey length:', clientSecretKey?.length);
          console.log('[NostrConnect] v37:   clientPubkey:', clientPubkey);
          
          this.signer = BunkerSigner.fromBunker(clientSecretKey, bunkerPointer, signerParams);
          
          console.log('[NostrConnect] v37: BunkerSigner created, signer.bp:', JSON.stringify({
