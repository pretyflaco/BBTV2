 ...
 * 
 * Note: NDK alternative available (see NostrConnectServiceNDK.js)
  ...
  static async connectWithBunkerURL(bunkerUrl, maxRetries = 1, forceNewClientKey = false, onAuthUrl = null) {
    ...
    try {
      ...
      if (!bunkerPointer.secret) {
        console.error('[NostrConnect] SECURITY: Bunker URL has no secret - rejecting to prevent hijacking');
        return { 
          success: false, 
