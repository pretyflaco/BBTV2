...
export const AUTH_VERSION = 'v69';
export const AUTH_VERSION_DATE = '2025-02-03';
export const AUTH_VERSION_DESCRIPTION = 'Add favicon.ico for external app icon display';

// Full version string for display
export const AUTH_VERSION_FULL = `${AUTH_VERSION}-favicon`;
