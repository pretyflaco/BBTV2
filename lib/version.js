...
export const AUTH_VERSION = 'v70';
export const AUTH_VERSION_DATE = '2025-02-03';
export const AUTH_VERSION_DESCRIPTION = 'Update signer recommendations - remove Aegis/Nowser';

// Full version string for display
export const AUTH_VERSION_FULL = `${AUTH_VERSION}-signers`;
