...
export const AUTH_VERSION = 'v72';
export const AUTH_VERSION_DATE = '2026-02-04';
export const AUTH_VERSION_DESCRIPTION = 'Fix auth race condition - show progress modal until server session established';

// Full version string for display
export const AUTH_VERSION_FULL = `${AUTH_VERSION}-session-modal`;
