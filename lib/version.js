...
export const AUTH_VERSION = 'v74';
export const AUTH_VERSION_DATE = '2026-02-04';
export const AUTH_VERSION_DESCRIPTION = 'Fix sign-in modal to show all 3 steps completing';

// Full version string for display
export const AUTH_VERSION_FULL = `${AUTH_VERSION}-session-modal-ux`;
