...
export const AUTH_VERSION = 'v73';
export const AUTH_VERSION_DATE = '2026-02-04';
export const AUTH_VERSION_DESCRIPTION = 'Fix hooks to wait for server session before fetching data';

// Full version string for display
export const AUTH_VERSION_FULL = `${AUTH_VERSION}-session-wait`;
