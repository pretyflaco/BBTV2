...
export const AUTH_VERSION = 'v71';
export const AUTH_VERSION_DATE = '2025-02-04';
export const AUTH_VERSION_DESCRIPTION = 'Fix mobile QR modal scrolling, add waiting indicator, update iOS flow';

// Full version string for display
export const AUTH_VERSION_FULL = `${AUTH_VERSION}-mobile-ux`;
