...
export const AUTH_VERSION = 'v68';
export const AUTH_VERSION_DATE = '2025-02-03';
export const AUTH_VERSION_DESCRIPTION = 'NIP-46 app icon + low-memory build fix';

// Full version string for display
export const AUTH_VERSION_FULL = `${AUTH_VERSION}-nip46-icon`;
