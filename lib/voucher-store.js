...
class VoucherStore {
  ...
  createVoucher(amount, apiKey, walletId, options = {}) {
    ...
    const voucher = {
      ...
      apiKey: apiKey,
      walletId: walletId,
      // Optional commission and display info
    ...
    this.saveToFile();
    console.log(`💳 Created voucher: ${chargeId} for ${amount} sats${options.commissionPercent ? ` (${options.commissionPercent}% commission)` : ''}`);
