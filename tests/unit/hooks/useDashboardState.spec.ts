...
describe('useDashboardState', () => {
  ...
  describe('Options', () => {
    ...
    it('should accept initialView option', () => {
      const { result } = renderHook(() => useDashboardState({ initialView: 'transactions' }));
  ...
  describe('commissionSettings namespace', () => {
    ...
    it('should expose commission settings actions', () => {
      ...
      expect(typeof result.current.commissionSettings.setCommissionEnabled).toBe('function');
    });
  });
  ...
  describe('Memoization', () => {
    it('should maintain stable references for individual namespaces', () => {
      ...
      const firstThemeStyles = result.current.themeStyles;
  ...
  describe('Exports', () => {
    it('should have a default export', async () => {
      const module = await import('../../../lib/hooks/useDashboardState');
      expect(module.default).toBe(module.useDashboardState);
    });

    it('should export the hook as named export', async () => {
      const module = await import('../../../lib/hooks/useDashboardState');
      expect(typeof module.useDashboardState).toBe('function');
    });
