...
describe('usePWAInstall', () => {
  ...
  describe('Deferred Prompt', () => {
    it('should set deferred prompt', () => {
      ...
      act(() => {
        result.current.setDeferredPrompt(mockPrompt as any);
      });
  ...
  describe('Derived State', () => {
    it('should update hasDeferredPrompt when prompt is set', () => {
      ...
      act(() => {
        result.current.setDeferredPrompt(createMockBeforeInstallPromptEvent() as any);
      });
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle multiple setDeferredPrompt calls', () => {
      ...
      act(() => {
        result.current.setDeferredPrompt(mockPrompt1 as any);
      });

      act(() => {
        result.current.setDeferredPrompt(mockPrompt2 as any);
      });
